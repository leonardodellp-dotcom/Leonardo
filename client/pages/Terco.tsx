  ...
  const dailyRosaries: RosaryDay[] = [
    {
      ...
      readings: [
        ...
        "Lucas 1:39-56 (Visitação)",
        "Lucas 2:1-20 (Nascimento)",
        "Lucas 2:22-38 (Apresentação)",
        "Lucas 2:41-52 (Encontro no Templo)",
      ],
    ...
    },
    {
      ...
      readings: [
        "Mateus 26:36-46 (Agonia)",
        "Mateus 27:24-26 (Flagelação)",
        "Mateus 27:27-31 (Coroação)",
        "Mateus 27:31-33 (Caminho da Cruz)",
        "Mateus 27:33-56 (Crucificação)",
      ],
    ...
    },
    {
      ...
      readings: [
        "Mateus 28:1-10 (Ressurreição)",
        "Atos 1:6-11 (Ascensão)",
        "Atos 2:1-21 (Pentecostes)",
        "Lucas 1:46-55 e Apocalipse 12:1 (Assunção)",
        "Apocalipse 12:1 (Coroação)",
      ],
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Aprenda tudo sobre o Terço (Rosário): as bolinhas, os mistérios de
              cada dia e as leituras recomendadas
            </p>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-8 mb-12">
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <Heart className="w-6 h-6 text-primary" />O que Cada Bolinha do
              Terço Significa
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {rosaryBeads.map((bead, idx) => (
                <div
                  key={idx}
                  className="border border-border rounded-lg p-5 bg-muted/30 dark:bg-muted/20"
                >
            ...
            <ol className="space-y-3">
              <li className="flex gap-4">
                ...
                <span className="text-muted-foreground">
                  <strong>Sinal da Cruz:</strong> Faça o sinal da cruz
                </span>
              </li>
              <li className="flex gap-4">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/20 text-primary flex items-center justify-center font-bold text-sm">
                ...
                <span className="text-muted-foreground">
                  <strong>Credo Apostólico:</strong> Reze na bolinha maior
                  (crucifixo)
                </span>
              </li>
              <li className="flex gap-4">
                ...
                <span className="text-muted-foreground">
                  <strong>Pai Nosso:</strong> Reze na primeira bolinha grande
                </span>
              </li>
              <li className="flex gap-4">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/20 text-primary flex items-center justify-center font-bold text-sm">
                ...
                <span className="text-muted-foreground">
                  <strong>Três Ave-Marias:</strong> Reze nas próximas três
                  bolinhas pequenas (intenção: fé, esperança e caridade)
                </span>
              </li>
              <li className="flex gap-4">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/20 text-primary flex items-center justify-center font-bold text-sm">
                ...
                <span className="text-muted-foreground">
                  <strong>Glória ao Pai:</strong> Reze na bolinha grande
                  seguinte
                </span>
              </li>
              <li className="flex gap-4">
                ...
                <span className="text-muted-foreground">
                  <strong>Anuncie o Mistério:</strong> Diga qual mistério você
                  vai meditar
                </span>
              </li>
              <li className="flex gap-4">
                ...
                <span className="text-muted-foreground">
                  <strong>Pai Nosso:</strong> Reze na próxima bolinha grande
                </span>
              </li>
              <li className="flex gap-4">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/20 text-primary flex items-center justify-center font-bold text-sm">
                ...
                <span className="text-muted-foreground">
                  <strong>Dez Ave-Marias:</strong> Reze nas dez bolinhas
                  pequenas enquanto medita no mistério
                </span>
              </li>
              <li className="flex gap-4">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/20 text-primary flex items-center justify-center font-bold text-sm">
                ...
                <span className="text-muted-foreground">
                  <strong>Glória ao Pai:</strong> Reze ao final de cada mistério
                </span>
              </li>
              <li className="flex gap-4">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/20 text-primary flex items-center justify-center font-bold text-sm">
                ...
                <span className="text-muted-foreground">
                  <strong>Repita:</strong> Continue com os próximos mistérios
                  (total de 5)
                </span>
              </li>
              <li className="flex gap-4">
                ...
                <span className="text-muted-foreground">
                  <strong>Salve Rainha:</strong> Termine com a Salve Rainha
                </span>
              </li>
            </ol>
          </div>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold mb-8 flex items-center gap-3">
              <Calendar className="w-8 h-8 text-primary" />O Terço de Cada Dia
            </h2>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          {day.mysteries[0]} - Clique para ver os mistérios e
                          leituras
                        </p>
                      ...
                      <div className="flex-shrink-0 ml-4">
                        <div
                          className={`text-2xl transition-transform ${expandedDayId === day.id ? "rotate-180" : ""}`}
                        >
                          ▼
                        </div>
                      </div>
            ...
            <div className="space-y-4">
              <div className="bg-primary/5 dark:bg-primary/5 p-4 rounded-lg border border-primary/20">
                ...
                <p className="text-sm text-muted-foreground">
                  Meditam sobre a alegria e esperança trazidas pelo nascimento
                  de Jesus. Incluem a Anunciação, Visitação, Nascimento de
                  Jesus, Apresentação no Templo e Encontro de Jesus no Templo.
                </p>
              </div>
              <div className="bg-primary/5 dark:bg-primary/5 p-4 rounded-lg border border-primary/20">
                <h4 className="font-bold text-primary mb-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Refletem sobre o sofrimento de Cristo pela salvação do mundo.
                  Incluem a Agonia no Horto, Flagelação, Coroação de Espinhos,
                  Jesus Carregando a Cruz e a Crucificação.
                </p>
              </div>
              <div className="bg-primary/5 dark:bg-primary/5 p-4 rounded-lg border border-primary/20">
                <h4 className="font-bold text-primary mb-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Celebram a vitória de Cristo sobre a morte e a glória de
                  Maria. Incluem a Ressurreição, Ascensão, Descida do Espírito
                  Santo, Assunção de Maria e Coroação de Maria.
                </p>
              </div>
              <div className="bg-primary/5 dark:bg-primary/5 p-4 rounded-lg border border-primary/20">
                <h4 className="font-bold text-primary mb-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Adicionados pelo Papa João Paulo II, focam na vida pública de
                  Jesus. Muitos fiéis rezam esses mistérios nas quintas-feiras
                  ou conforme sua devoção pessoal.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-xl p-8 mb-12">
            <h3 className="text-2xl font-bold text-green-900 dark:text-green-100 mb-4">
              🙏 Benefícios da Prática do Terço
            </h3>
            <ul className="space-y-3 text-green-800 dark:text-green-200 text-sm">
              ...
              <li className="flex gap-3">
                <span className="flex-shrink-0">✓</span>
                <span>
                  Promove meditação profunda sobre a vida de Jesus e Maria
                </span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0">✓</span>
