...
export default function CalendarioLiturgico() {
  ...
  const monthDates = liturgicalDates.filter(date => date.month === selectedMonth);
      ...
      <div className="min-h-[calc(100vh-200px)] px-4 py-12">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Dia ordinário do calendário</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold mb-6">{monthNames[selectedMonth - 1]} de 2025</h2>
          ...
          <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mt-12">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-200 leading-relaxed">
              ...
              festas e memórias. Acompanhe este calendário para participar das principais celebrações
              em nossa paróquia.
            </p>
          </div>
