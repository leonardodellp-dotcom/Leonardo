...
export default function BibliotecaCatolica() {
  ...
  const resources: Resource[] = [
    {
      ...
      description:
        "Documento oficial contendo toda a doutrina católica, sacramentos, mandamentos e moral cristã.",
    ...
    },
    {
      ...
      description:
        "Um dos mais influentes escritos da espiritualidade cristã. Autobiografia teológica de profunda reflexão espiritual.",
    ...
    },
    {
      ...
      description:
        "Obra-prima da literatura que descreve a jornada espiritual através do Inferno, Purgatório e Paraíso.",
    ...
    },
    {
      ...
      description:
        "Clássico espiritual sobre como viver uma vida cristã verdadeira, seguindo o exemplo de Cristo.",
    ...
    },
    {
      ...
      description:
        "Resumo acessível da principal obra teológica católica. Aborda Deus, fé, virtudes e sacramentos.",
    ...
    },
    {
      ...
      description:
        "Guia prático para crescimento espiritual na vida cotidiana, com conselhos para oração e virtude.",
    ...
    },
    {
      ...
      description:
        "PDF gratuito explicando os mistérios gozosos, dolorosos e gloriosos com meditações.",
      link: "#",
      featured: true,
    },
    {
      ...
      category: "link",
      description:
        "Coleção oficial de todas as encíclicas e documentos publicados pelos Papas.",
    ...
    },
    {
      ...
      author: "Santo Tomás de Aquino",
      description:
        "Coletânea de orações e reflexões espirituais do grande doutor da Igreja.",
      link: "#",
    },
    {
      id: "10",
      ...
      description:
        "Um santo diferente para cada dia do ano, com sua história e lições espirituais.",
    ...
    },
    {
      ...
      description:
        "Defesa sistemática da fé católica contra objeções comuns, com argumentos teológicos e históricos.",
    ...
    },
    {
      ...
      description:
        "Guia ilustrado mostrando o caminho da conversão, salvação e comunhão com Deus.",
      link: "#",
    },
  ];
  ...
  const categories = [
    { id: "all", label: "Todos", count: resources.length },
    {
      id: "book",
      label: "Livros",
      count: resources.filter((r) => r.category === "book").length,
    },
    {
      id: "pdf",
      label: "PDFs",
      count: resources.filter((r) => r.category === "pdf").length,
    },
    {
      id: "link",
      label: "Links",
      count: resources.filter((r) => r.category === "link").length,
    },
  ];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Acesse uma coleção curada de livros, documentos PDF e recursos
              para aprofundar seu conhecimento da fé católica
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-primary/20 via-accent/20 to-primary/20 border border-primary/30 rounded-xl p-8 mt-12 shadow-glow">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Nossa Biblioteca Católica contém os clássicos mais importantes da
              espiritualidade cristã, desde os Padres da Igreja até documentos
              modernos do Vaticano. Todos os recursos foram selecionados para
              ajudar você a aprofundar sua fé, compreender melhor a doutrina
              católica e encontrar orientação espiritual. Muitos estão
