  ...
  const prayerMethods: PrayerMethod[] = [
    {
      ...
      description:
        "Uma das práticas mais tradicionais da Igreja Católica, o rosário é uma meditação estruturada sobre a vida de Jesus e Maria.",
      steps: [
        "Comece com o Sinal da Cruz",
        "Reze o Credo Apostólico no crucifixo",
        "Reze um Pai Nosso na primeira conta grande",
        "Reze três Ave-Marias nas próximas contas pequenas",
        "Reze um Glória ao Pai",
        "Anuncie o primeiro mistério e reze um Pai Nosso",
        "Reze dez Ave-Marias enquanto medita sobre o mistério",
        "Reze um Glória ao Pai",
        "Repita o processo para os cinco mistérios do dia",
      ],
