...
export function getBadges(
  userStats: Partial<UserGameStats>,
): BadgeDefinition[] {
  const badges: BadgeDefinition[] = [
    // Activity badges
    {
      ...
      unlockedDate: userStats.badges?.find(
        (b) => b.id === "iniciante-espiritual",
      )?.unlockedDate,
    },
    {
      id: "estudioso-da-fe",
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "estudioso-da-fe")
        ?.unlockedDate,
    },
    {
      id: "campeao-desafios",
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "campeao-desafios")
        ?.unlockedDate,
    },
    {
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "aprendiz-evangelho")
        ?.unlockedDate,
    },
    {
      id: "guerreiro-oracao",
    ...
    // Social badges
    {
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "respondeu-chat")
        ?.unlockedDate,
    },
    {
      id: "ganhou-coracoes",
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "ganhou-coracoes")
        ?.unlockedDate,
    },
    {
      id: "ideia-aprovada",
    ...
    },
    {
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "conectador")
        ?.unlockedDate,
    },
    {
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "mensageiro-palavra")
        ?.unlockedDate,
    },
    // Learning badges
    {
    ...
    // Milestone badges
    {
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "nivel-5")
        ?.unlockedDate,
    },
    {
      id: "nivel-10",
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "nivel-10")
        ?.unlockedDate,
    },
    {
      id: "1000-xp",
      ...
      unlockedDate: userStats.badges?.find((b) => b.id === "1000-xp")
        ?.unlockedDate,
    },
  ];
